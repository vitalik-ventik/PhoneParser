...
class ParserDoskiCoil(Parser):
    index = None

    def __init__(self):
        super().__init__('http://doski.co.il/')
        self.num_threads = 0
    ...
    def load_doski_coil_phones(self):
...
if __name__ == '__main__':
    try:
        ...
        parser_doski_coil = ParserDoskiCoil()
        parser_doski_coil.start()
        parser_doski_coil.join()
    finally:
