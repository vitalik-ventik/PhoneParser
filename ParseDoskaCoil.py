...
class ParserDoskaCoil(Parser):
    index = None

    def __init__(self):
        super().__init__('http://doska.co.il/')
        self.num_threads = 0
    ...
    def load_doska_coil_phones(self):
...
if __name__ == '__main__':
    try:
        ...
        parser_doska_coil = ParserDoskaCoil()
        parser_doska_coil.start()
        parser_doska_coil.join()
    finally:
